      ...
      <b-col cols="12" md="2" class="h-100 bg-info border-top text-center p-3">
        <b-nav vertical id="nav">
          <b-nav-item-dropdown text="新闻资讯">
            <b-dropdown-item
              :to="{ path: '/admin/edit/news', query: { type: 'cto' } }"
              >企业新闻</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/news', query: { type: 'hy' } }"
              >行业新闻</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/news', query: { type: 'cp' } }"
              >产品新闻</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/news', query: { type: 'sv' } }"
              >服务通告</b-dropdown-item
            >
          </b-nav-item-dropdown>
          <b-nav-item-dropdown text="成功案例">
            <b-dropdown-item
              :to="{ path: '/admin/edit/case', query: { type: 'power' } }"
              >UPS电源</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/case', query: { type: 'yth' } }"
              >一体化机柜</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/case', query: { type: 'dt' } }"
              >数据中心</b-dropdown-item
            >
            <b-dropdown-item
              :to="{ path: '/admin/edit/case', query: { type: 'ac' } }"
