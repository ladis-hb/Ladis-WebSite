...
export default Vue.extend({
  ...
  methods: {
    async SendEdit(Type: string) {
      ...
      const link = `/case/${date+new Date().getSeconds()}`
      ...
      const newListContent:caseList =deepmerge(newsContent,{MainTitle:title,MainUrl:link,MainParent:editType,title,content,text:null})
